        ...
        <div className="flex max-w-2xl mx-auto shadow border-b">
            <div className="px-8 py-8">
                ...
                <div className="items-center justify-center h-14 w-full my-4 space-x-4 pt-4">
                    <button onClick= {updateEmployee} className='rounded text-white font-semibold bg-green-400 px-6 py-2 hover:bg-green-700'>
                        Update
                    </button>
                    <button onClick={() => navigate('/')} className='rounded text-white font-semibold bg-red-400 px-6 py-2 hover:bg-red-700'>
                        Cancel
                    </button>
                </div>
            </div>
